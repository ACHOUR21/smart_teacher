        ...
        <div className="flex-1 overflow-y-auto">
          {filtered.length === 0 ? (
            <div className="text-center py-12 text-gray-400 px-4">
              ...
              <p className="text-xs mt-1">Students can start a chat with you</p>
            </div>
          ) : (
            filtered.map((c) => {
              const other = c.participants[0]
              ...
              return (
                ...
                >
                  <div className="h-10 w-10 rounded-full bg-gradient-to-br from-primary-400 to-primary-600 flex items-center justify-center text-white text-xs font-bold flex-shrink-0">
                    {getInitials(other)}
                  </div>
                  <div className="flex-1 min-w-0">
                    ...
                    <span className={cn('text-[10px] font-medium px-1.5 py-0.5 rounded-full', roleColor[other.role] ?? roleColor.STUDENT)}>
      ...
      {activeConvId && otherParticipant ? (
        ...
        <div className="flex-1 flex items-center justify-center bg-slate-50 dark:bg-slate-950">
          <div className="text-center text-gray-400">
            ...
            <p className="text-sm mt-1">Choose one from the list to start chatting</p>
          </div>
        </div>
      )}
    </div>
